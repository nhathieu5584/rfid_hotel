	...
	if (isset($_GET['success'])) {
		if ($_GET['success'] == "updated") {
			echo '	<script type="text/javascript">
			 			setTimeout(function () {
			                $(".up_info2").fadeIn(200);
			                $(".up_info2").text("Tài khoản của bạn đã được cập nhật");
              			}, 500);
              			setTimeout(function () {
...
<div class="topnav" id="myTopnav">
	<a href="index.php"><b>Khách hàng</b></a>
    <a href="ManageUsers.php"><b>Quản lí khách hàng</b></a>
    
    <?php  
    	if (isset($_SESSION['Admin-name'])) {
    		echo '<a href="#" data-toggle="modal" data-target="#admin-account"><b>'.$_SESSION['Admin-name'].'</b></a>';
    		echo '<a href="logout.php"><b>Đăng xuất</b></a>';
    	}
    	else{
    		echo '<a href="login.php"><b>Đăng nhập</b></a>';
    	}
    ?>
    ...
    <div class="modal-content">
      ...
      <form action="ac_update.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	      	...
	      	<input type="text" name="up_name" placeholder="Nhập tên..." value="<?php echo $_SESSION['Admin-name']; ?>" required/><br>
	      	<label for="User-mail"><b>Địa chỉ E-mail:</b></label>
	      	<input type="email" name="up_email" placeholder="Nhập địa chỉ E-mail..." value="<?php echo $_SESSION['Admin-email']; ?>" required/><br>
	      	<label for="User-psw"><b>Mật khẩu</b></label>
	      	<input type="password" name="up_pwd" placeholder="Nhập mật khẩu..." required/><br>
	      </div>
